...
if tool == 1:
    ...
    if cfg_work == 1:
        ...
        if cfg_rec == 1:
            ...
            os.system("echo '" + twrp_path + "' >> $(pwd)/" + cfg_name)
            ...
            os.system("echo '" + guide + "' >> $(pwd)/" + cfg_name)
            os.system("mv " + cfg_name + " config.py")
            ...
            os.system("echo '" + ofox_type + "' >> $(pwd)/" + cfg_name)
            ...
            os.system("echo '" + ofox_path + "' >> $(pwd)/" + cfg_name)
            ...
            os.system("echo '" + ofox_unpack + "' >> $(pwd)/" + cfg_name)
            cfg_rec_guide = input("Хотите ли вы, чтобы программа рассказала вам о том, как установить рекавери на постоянку (true/false) => ")
            guide = ('show_guide = "' + cfg_rec_guide + '"')
            os.system("echo '" + guide + "' >> $(pwd)/" + cfg_name)
            os.system("mv " + cfg_name + " config.py")
        ...
        os.system("echo '" + firmw_path + "' >> $(pwd)/" + cfg_name)
        os.system("mv " + cfg_name + " config.py")
        input("\nГотово (нажмите enter для выхода)")
        exit(0)
        ...
        os.system("echo '" + rom_rec_path + "' >> $(pwd)/" + cfg_name)
        os.system("mv " + cfg_name + " config.py")
        input("\nГотово (нажмите enter для выхода)")
        exit(0)
        ...
        if cfg_mgsk_file == "my":
            ...
            os.system("echo '" + mgsk_ver + "' >> $(pwd)/" + cfg_name)
            os.system("mv " + cfg_name + " config.py")
            input("\nГотово (нажмите enter для выхода)")
            exit(0)
    ...
    if work_type == "recovery" and recovery_type == "twrp" and show_guide == "true":
        ...
        input("Убедитесь, что все правильно и нажмите enter")
        os.system("unzip " + recovery_path + " -d " + unpackfolder + " && cd " + unpackfolder + " && fastboot boot recovery.img")        
